...
CREATE TABLE `account` (
  ...
  `proco_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`username`),
  UNIQUE KEY `username_UNIQUE` (`username`),
  KEY `fk_proco_account_idx` (`proco_id`),
...
INSERT INTO `account` VALUES ('caramel6','$2a$10$h.dl5J86rGH7I8bD9bZeZeci0pDt0.VwFTGujlnEaZXPf/q7vM5wO','caramelwilson@gmail.com','Australia','Female','Cara','Wilson', 1, 0);
INSERT INTO `account` VALUES ('bjames3','$2a$10$h.dl5J86rGH7I8bD9bZeZeci0pDt0.VwFTGujlnEaZXPf/q7vM5wO','bond.james@protonmail.com','America','Non-Binary','James','Bond', 2, 9);
INSERT INTO `account` VALUES ('jlaw12','$2a$10$h.dl5J86rGH7I8bD9bZeZeci0pDt0.VwFTGujlnEaZXPf/q7vM5wO','notanactor3213@exchange.com','European','Male','Jude','Law', 0, 0);
INSERT INTO `account` VALUES ('noReqSubmitted','$2a$10$h.dl5J86rGH7I8bD9bZeZeci0pDt0.VwFTGujlnEaZXPf/q7vM5wO','test3213@exchange.com','European','Male','Mat','Tam', 0, 0);
...
INSERT INTO `production_company` VALUES (0,'(not PCo)');
INSERT INTO `production_company` VALUES (1,'Universal Pictures'),(2,'Paramount Pictures'),(3,'20th Century Fox'),(4,'Warner Bros.'),(5,'DreamWorks Pictures'),(6,'Metro-Goldwyn-Meyer'),(7,'Miramax'),(8,'Columbia Pictures'),(9,'Walt Disney Pictures'),(10,'Sony Pictures'),(11,'New Line Cinema'),(12, 'AMC');
...
CREATE TABLE `show` (
  ...
  `movie_or_series` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `show` VALUES (1, 9, 'Star Wars: Episode IX - The Rise of Skywalker','Action', 2019, 142, 1, 1);
INSERT INTO `show` VALUES (2, 2, 'Forrest Gump','Drama', 1994, 142, 1, 1);
INSERT INTO `show` VALUES (3, 12, 'Breaking Bad: Season 3','Drama', 2010, 47, 0, 1);
INSERT INTO `show` VALUES (4, 6, 'The Apprentice: Season 15','Reality compeition', 2010, 60, 0, 1);
INSERT INTO `show` VALUES (5, 5, 'Cooked: Season 1','Cooking', 2007, 45, 0, 0);
INSERT INTO `show` VALUES (6, 8, 'Explained: Season 3','Informative', 2010, 60, 0, 0);
INSERT INTO `show` VALUES (7, 3, 'I Am Stoned','Comedy', 2040, 124, 1, 0);
INSERT INTO `show` VALUES (8, 9, 'I love Uni','Fantasy', 1998, 98, 1, 0);
...
INSERT INTO `user_review` VALUES (1,1,'userExample1',4,'My favourite star wars movie of the sequels','2020-04-24');
INSERT INTO `user_review` VALUES (2,1,'userExample2',1,'this has got to be the worst star trek ive ever seen','2020-01-01');
INSERT INTO `user_review` VALUES (3,1,'userExample3',5,'','2020-01-04');
/*!40000 ALTER TABLE `user_review` ENABLE KEYS */;
UNLOCK TABLES;


--
-- Table structure for table `account_requestform`
--

DROP TABLE IF EXISTS `account_requestform`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `account_requestform` (
  `user_id` varchar(45) NOT NULL,
  `reason` varchar(1000) NOT NULL,
  `requested_acc_type` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`user_id`),
  KEY `fk_username_idx` (`user_id`),
  CONSTRAINT `fk_userId` FOREIGN KEY (`user_id`) REFERENCES `account` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `account_requestform` WRITE;
/*!40000 ALTER TABLE `account_requestform` DISABLE KEYS */;
INSERT INTO `account_requestform` VALUES ("test6", "pls", "2");
/*!40000 ALTER TABLE `account_requestform` ENABLE KEYS */;
UNLOCK TABLES;
